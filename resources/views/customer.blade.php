<x-app-layout>
   ...
   <div class="bg-gray-900">
    ...
    style="background-image: url('https://i.pinimg.com/originals/78/20/0e/78200e30b2ecfd6befe24769876aa914.jpg'); height: 600px">
    <div
      class="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed"
      style="background-color: rgba(0, 0, 0, 0.6)">
      <div class="flex h-full items-center justify-center">
        <div class="text-white">
          <h1 class="mb-4 text-6xl font-semibold">Divine.lk</h1>
          <h2 class="mb-4 text-4xl font-semibold">Delicious cakes to
            Order</h2>
          <h4 class="mb-6 text-xl font-semibold">Here you can choose 
            a cake suitable for any person,
            for every taste and color and
            for anyone . Choose!</h4>
          <button
            type="button"
    ...
    <br>
    <h1 class="mb-4 text-3xl font-semibold text-center text-gray-100">Spacial Cakes</h1>
    
    <div class="flex gap-6 justify-center items-center m-5">
      <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-5">
          <img src="\images\Group 3.png" alt="">
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Rainbow Swirl</h5>
            </a>
      ...
      <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-5">
          <img src="\images\Group 4.png" alt="">
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Choco-Mint Madness</h5>
            </a>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
            <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Buy
      ...
      <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-5">
          <img src="\images\Group 5.png" alt="">
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Cookies & Cream Dream</h5>
            </a>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
            <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Buy
    ...
    <h1 class="mb-4 text-3xl font-semibold text-center text-gray-100">Birthday Cakes</h1>
    <div class="flex gap-6 justify-center items-center m-5">
      <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <section class="bg-white dark:bg-gray-900">
      <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          <div class="mx-auto max-w-screen-sm">
              ...
              <p class="mb-8 font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Discover what our customers have to say about our delectable cakes and exceptional service.</p>
          </div> 
   ...
   <!-- Footer container -->
<footer
class="bg-neutral-900 text-center text-neutral-600 dark:bg-grey-600 dark:text-neutral-200 lg:text-left">
<div
...
<!--Copyright section-->
<div class="bg-neutral-900 p-6 text-center dark:bg-neutral-900">
